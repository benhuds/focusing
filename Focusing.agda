...
module Focusing where
  ...
  ex5 : ∀ {A B} → [] ,, None |- (A ⇒' (B ⇒' (A ×' B)))
  ex5 = arr-r (arr-r (conj-r (focus (iS i0) init) (focus i0 init)))

  ex6 : ∀ {A B} → [] ,, None |- (A ⇒' (A ×' (B ⇒' B)))
  ex6 = arr-r (conj-r (focus i0 init) (arr-r (focus i0 init)))
